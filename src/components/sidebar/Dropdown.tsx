...
export default function Dropdown({
  ...
  return (
    ...
    >
      <AccordionTrigger
        id={listType}
        className="p-2 text-sm text-muted-foreground hover:no-underline"
      >
        <div className={groupIdentifies}>
          <div className="flex items-center justify-center gap-4 overflow-hidden">
            <div className="relative">
              <TooltipComponent message="Change Emoji">
            ...
            <input
              ...
              className={cn('w-[140px] overflow-hidden outline-none', {
          ...
          <div className={hoverStyles}>
            <TooltipComponent message="Delete Folder">
              <Trash
                onClick={moveToTrash}
                size={15}
                className="mr-1 transition-colors hover:dark:text-white"
              />
            </TooltipComponent>
