  ...
  return (
    ...
    >
      <path
        ...
        className={`fill-[#D3D3D3] text-xl transition-all group-hover/native:fill-purple-400/50 dark:fill-[#2B2939]`}
      />
      <path
        d="M9 16C9 14.8954 9.89543 14 11 14H13C14.1046 14 15 14.8954 15 16V22H9V16Z"
        className={`fill-Neutrals/neutrals-7  fill-Neutrals/neutrals-7 group-hover/native:fill-washed-blue-500 transition-all dark:fill-[#817EB5]`}
      />
    </svg>
  )
}
